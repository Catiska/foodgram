...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    def validate_ingredients(self, ingredients, model=Ingredient):
        valid_ingredients = {}
        for ingredient in ingredients:
            ...
            # Заполняет количество ингредиентов, суммирует одинаковые:
        ...
        if not valid_ingredients:
            raise ValidationError('Добавьте корректные ингредиенты')

        # Проверяет наличие ингредиента в базе:
        ...
        # Заполняет словарь провалидированных данных:
